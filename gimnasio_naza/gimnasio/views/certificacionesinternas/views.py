...
class CertificacioninternaListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['crear_url'] = reverse_lazy('app:crear_certificacioninterna')
        return context
...
class CertificacioninternaCreateView(CreateView):
    ...
    success_url = reverse_lazy('app:listar_certificacioninterna')
...
class CertificacioninternaDeleteView(DeleteView):
    model = Certificacion_interna
    template_name = 'certificacioninternas/eliminar.html'
    success_url = reverse_lazy('app:listar_certificacioninterna')
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['titulo'] = 'Eliminar certificación interna'
        context['listar_url'] = reverse_lazy('app:listar_certificacioninterna')
        return context
