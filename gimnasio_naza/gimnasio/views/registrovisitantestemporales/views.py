...
class RegistrovisitantetemporalListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['crear_url'] = reverse_lazy('app:crear_registrovisitante')
        return context
...
class RegistrovisitantestemporalCreateView(CreateView):
    ...
    success_url = reverse_lazy('app:listar_registrovisitante')
...
class RegistrovisitantetemporalDeleteView(DeleteView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['listar_url'] = reverse_lazy('app:listar_registrovisitante')
        return context
