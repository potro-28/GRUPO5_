...
from gimnasio.views.reportes.reportes import ExportarReportes_estadisticasPDF, ExportarReportes_estadisticasEXCEL,ExportarSoporte_PQRSPDF ,ExportarSoporte_PQRSEXCEL
