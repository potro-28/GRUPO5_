...
urlpatterns = [
    ...
    path('crear-usuario-ajax/', crear_usuario_ajax, name='crear_usuario_ajax'),  # ✅ Solo una vez
...
#==============================asistencia==============================#
    ...
    path('enviar_encuesta_usuarios/', enviar_encuesta_usuarios, name='enviar_encuesta_usuarios'),
