...
urlpatterns = [
    ...
    path('listar_elemento/', ElementoListView.as_view(), name='listar_elemento'),
...
#==============================mantenimiento==============================#
    ...
    path('modificar_mantenimiento/<int:pk>/', MantenimientoUpdateView.as_view(), name='editar_mantenimiento'),
